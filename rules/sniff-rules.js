...
// resource-profile:flagqaz/AegisScope:99adf0bf9fce110c:6aac1fad91fec7ab
window.AEGISSCOPE_SNIFF_RULES = [
  ...
  },
  {
    ...
    minScore: 74,
    matchers: [
      { source: 'jqueryRuntime', regex: '^version:([0-9][\\w.-]+)$', score: 100, version: 1 },
      { source: 'jqueryRuntime', regex: 'jQuery\\.fn|dollar\\.fn\\.jquery', score: 98 },
      { source: 'jqueryRuntime', regex: 'migrate:|ui:|mobile:|plugin:', score: 84 },
      ...
      { source: 'globals', key: 'jQuery.migrateVersion', regex: '([0-9][\\w.-]+)', score: 84 },
      { source: 'globals', key: 'jQuery.ui.version', regex: '([0-9][\\w.-]+)', score: 82 },
      { source: 'globals', key: 'jQuery.mobile.version', regex: '([0-9][\\w.-]+)', score: 82 },
      { source: 'scriptSrc', regex: '(?:^|[\\W_/])jquery[-.]([0-9]+(?:\\.[0-9][0-9A-Za-z_-]*){1,4})(?:\\.min)?\\.js(?:[?#]|$)', score: 94, version: 1 },
      { source: 'scriptSrc', regex: '(?:^|[\\W_/])jquery(?:\\.min)?\\.js(?:[?#]|$)|/(?:jquery|jquery-core)/(?:[0-9][\\w.-]+/)?jquery(?:\\.min)?\\.js(?:[?#]|$)', score: 90 },
      { source: 'scriptSrc', regex: '(?:^|[\\W_/])jq(?:uery)?([0-9]{2,4})(?:\\.min)?\\.js(?:[?#]|$)', score: 88, version: 1, versionFormat: 'jqueryCompact' },
      { source: 'scriptSrc', regex: 'code\\.jquery\\.com/jquery-([0-9]+(?:\\.[0-9][0-9A-Za-z_-]*){1,4})(?:\\.min)?\\.js|ajax\\.googleapis\\.com/ajax/libs/jquery/([0-9]+(?:\\.[0-9][0-9A-Za-z_-]*){1,4})/|cdn\\.jsdelivr\\.net/npm/jquery@([0-9]+(?:\\.[0-9][0-9A-Za-z_-]*){1,4})|unpkg\\.com/jquery@([0-9]+(?:\\.[0-9][0-9A-Za-z_-]*){1,4})|cdnjs\\.cloudflare\\.com/ajax/libs/jquery/([0-9]+(?:\\.[0-9][0-9A-Za-z_-]*){1,4})/', score: 92, version: [1, 2, 3, 4, 5] },
      { source: 'resourceUrl', regex: '(?:^|[\\W_/])jquery[-.]([0-9]+(?:\\.[0-9][0-9A-Za-z_-]*){1,4})(?:\\.min)?\\.js(?:[?#]|$)', score: 88, version: 1 },
      { source: 'resourceUrl', regex: '(?:^|[\\W_/])jquery(?:\\.min)?\\.js(?:[?#]|$)|/(?:jquery|jquery-core)/(?:[0-9][\\w.-]+/)?jquery(?:\\.min)?\\.js(?:[?#]|$)', score: 84 },
      { source: 'resourceUrl', regex: '(?:^|[\\W_/])jq(?:uery)?([0-9]{2,4})(?:\\.min)?\\.js(?:[?#]|$)', score: 82, version: 1, versionFormat: 'jqueryCompact' },
      { source: 'resourceUrl', regex: 'code\\.jquery\\.com/jquery-([0-9]+(?:\\.[0-9][0-9A-Za-z_-]*){1,4})(?:\\.min)?\\.js|ajax\\.googleapis\\.com/ajax/libs/jquery/([0-9]+(?:\\.[0-9][0-9A-Za-z_-]*){1,4})/|cdn\\.jsdelivr\\.net/npm/jquery@([0-9]+(?:\\.[0-9][0-9A-Za-z_-]*){1,4})|unpkg\\.com/jquery@([0-9]+(?:\\.[0-9][0-9A-Za-z_-]*){1,4})|cdnjs\\.cloudflare\\.com/ajax/libs/jquery/([0-9]+(?:\\.[0-9][0-9A-Za-z_-]*){1,4})/', score: 86, version: [1, 2, 3, 4, 5] },
      { source: 'html', regex: '<script[^>]+src=["\'][^"\']*(?:jquery[-.]([0-9]+(?:\\.[0-9][0-9A-Za-z_-]*){1,4})(?:\\.min)?\\.js|/(?:jquery|jquery-core)/([0-9]+(?:\\.[0-9][0-9A-Za-z_-]*){1,4})/jquery(?:\\.min)?\\.js|code\\.jquery\\.com/jquery-([0-9]+(?:\\.[0-9][0-9A-Za-z_-]*){1,4})(?:\\.min)?\\.js)', score: 84, version: [1, 2, 3] },
      { source: 'scripts', regex: '\\bjQuery\\.fn\\.jquery\\b|\\$\\.fn\\.jquery\\b|\\bjQuery\\.(?:ajax|extend|each|noConflict)\\b', score: 80 },
      { source: 'scripts', regex: 'jQuery JavaScript Library|jquery\\.com', score: 88 }
    ]
  },
  {
    id: 'vue',
    ...
    matchers: [
      ...
      { source: 'vueRuntime', regex: '__VUE__|__VUE_HOT_MAP__|nuxt-runtime|vue-router-runtime|vuex-runtime|pinia-runtime|vue-ecosystem-global', score: 88 },
      { source: 'vueMarker', regex: 'data-v-app|data-v-[a-f0-9]{6,}|data-server-rendered|data-vue-meta|nuxt-root|router-element', score: 92 },
      { source: 'vueMarker', regex: 'data-n-head|data-head-attrs|vue-directive-attr', score: 82 },
      ...
      { source: 'globals', key: 'Vuex.version', regex: '.+', score: 86 },
      { source: 'globals', key: 'Pinia', regex: '.+', score: 86 },
      { source: 'globals', key: 'Pinia.createPinia', regex: '.+', score: 86 },
      { source: 'globals', key: '$nuxt', regex: '.+', score: 92 },
      { source: 'globals', key: '__NUXT__', regex: '.+', score: 92 },
      { source: 'globals', key: 'useNuxtApp', regex: '.+', score: 88 },
      { source: 'globals', key: '__VUE__', regex: '.+', score: 88 },
      { source: 'globals', key: '__VUE_HOT_MAP__', regex: '.+', score: 88 },
      ...
      { source: 'selector', selector: '[data-v-app]', equals: '[data-v-app]', score: 90 },
      { source: 'selector', selector: '[data-server-rendered]', equals: '[data-server-rendered]', score: 88 },
      { source: 'selector', selector: 'meta[data-vue-meta]', equals: 'meta[data-vue-meta]', score: 86 },
      { source: 'selector', selector: '#__nuxt, #__layout, [id^="__nuxt"]', equals: '#__nuxt, #__layout, [id^="__nuxt"]', score: 86 },
      { source: 'selector', selector: 'router-view, router-link', equals: 'router-view, router-link', score: 86 },
      { source: 'html', regex: 'data-v-app|data-v-[a-f0-9]{6,}|data-server-rendered|data-vue-meta|data-n-head|id=["\\\']__(?:nuxt|layout)["\\\']|<router-view|<router-link|vue-router|__VUE_SSR_CONTEXT__|__NUXT__', score: 88 },
      { source: 'scripts', regex: '(?=.*\\bopenBlock\\s*\\()(?=.*\\bcreateElement(?:VNode|Block)\\s*\\()', score: 92 },
      { source: 'scripts', regex: '\\bnew\\s+Vue\\s*\\(|\\bVue\\.(?:component|use|mixin|directive|filter)\\s*\\(', score: 92 },
      { source: 'scripts', regex: '__VUE_HMR_RUNTIME__|__VUE_HOT_MAP__|__VUE_SSR_CONTEXT__|__NUXT__', score: 88 },
      { source: 'scripts', regex: '(?=.*\\bcreateApp\\s*\\()(?=.*\\bmount\\s*\\()', score: 86 },
      ...
      { source: 'scriptSrc', regex: 'vue(?:\\.runtime)?(?:\\.global)?(?:\\.esm(?:-browser|-bundler)?)?(?:\\.prod)?(?:\\.min)?\\.js|unpkg\\.com/vue@([0-9][\\w.-]+)|cdn\\.jsdelivr\\.net/npm/vue@([0-9][\\w.-]+)|vue-router|vuex|pinia|@vue[\\/]|/_nuxt/|/\\.vitepress/', score: 88, versionRegex: 'vue@([0-9][\\w.-]+)' },
      { source: 'resourceUrl', regex: 'vue(?:\\.runtime)?(?:\\.global)?(?:\\.esm(?:-browser|-bundler)?)?(?:\\.prod)?(?:\\.min)?\\.js|vue-router|vuex|pinia|@vue[\\/]|/_nuxt/|/\\.vitepress/', score: 82 }
    ]
  },
  {
    id: 'react',
