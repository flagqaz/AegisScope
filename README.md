...
浏览器辅助模块位于主弹窗第二行功能区，V2.2.1 已接入“解除复制”和“WebRTC”两个能力。
...
UA 修改和网站编码修改入口已在 V2.2.1 主弹窗中预留，当前显示“功能正在开发中”，后续版本会继续接入。
